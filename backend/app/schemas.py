...
class PolicyAskRequest(BaseModel):
    question: str
    project_id: Optional[str] = None   # optional: lets the answer reference project context
...
class PolicyAskResponse(BaseModel):
    ...
    grounded: bool   # False if no policy chunks matched above threshold — answer says so explicitly
